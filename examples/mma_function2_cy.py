...
Optimization of a simple function with two design variables and one constraint function.
Uses the Cython-compiled mmacy module.
...
from mmapy.mmacy import mmasub, kktcheck
...
def main() -> None:
    ...
    file = os.path.join(path, "mma_function2_cy.log")
